...
const Navbar = () => {
    ...
    return (
        <div className='bg-slate-300 flex items-center justify-between py-5 px-20 font-medium w-full'>
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-slate-900 text-white aspect-square rounded-full text-[8px]'>10</p>
                </Link>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 border' to='/collection'>COLECCIONES</NavLink>
